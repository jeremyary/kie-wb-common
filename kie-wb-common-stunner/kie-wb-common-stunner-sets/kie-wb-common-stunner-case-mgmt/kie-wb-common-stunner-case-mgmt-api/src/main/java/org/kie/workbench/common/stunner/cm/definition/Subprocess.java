...
public class Subprocess implements CaseManagementViewDefinition {

    @Category
    public static final transient String category = CaseManagementCategories.SUBPROCESS;
    ...
    public Subprocess() {
        this(new CaseManagementGeneralSet("Subprocess"),
             new BackgroundSet(),
             new FontSet(),
             new RectangleDimensionsSet());
    }

    public Subprocess(final @MapsTo("general") CaseManagementGeneralSet general,
