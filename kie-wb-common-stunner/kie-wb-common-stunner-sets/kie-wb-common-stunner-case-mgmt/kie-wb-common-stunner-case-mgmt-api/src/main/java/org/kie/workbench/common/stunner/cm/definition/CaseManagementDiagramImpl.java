...
import org.kie.workbench.common.stunner.cm.definition.general.CaseManagementBaseInfo;
...
@CanContain(roles = {"strip_parent", "cm_nop"})
@FormDefinition(
...
public class CaseManagementDiagramImpl implements CaseManagementDiagram {

    @Category
    public static final transient String category = CaseManagementCategories.CONTAINERS;
    ...
    public CaseManagementDiagramImpl() {
        this(new DiagramSet(""),
             new ProcessData(),
             new BackgroundSet(),
             new FontSet(),
    ...
    public CaseManagementDiagramImpl(final @MapsTo("diagramSet") DiagramSet diagramSet,
    ...
    @Override
    public CaseManagementBaseInfo getGeneral() {
    ...
    public boolean equals(Object o) {
        if (o instanceof CaseManagementDiagram) {
            CaseManagementDiagramImpl other = (CaseManagementDiagramImpl) o;
