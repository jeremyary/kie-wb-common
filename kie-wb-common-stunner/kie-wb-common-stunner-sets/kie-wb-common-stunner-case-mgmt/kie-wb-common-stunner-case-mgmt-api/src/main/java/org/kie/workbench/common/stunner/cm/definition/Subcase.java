...
public class Subcase implements CaseManagementViewDefinition {
    ...
    public Subcase() {
        this(new CaseManagementGeneralSet("Subcase"),
             new BackgroundSet(),
             new FontSet(),
             new RectangleDimensionsSet());
    }

    public Subcase(final @MapsTo("general") CaseManagementGeneralSet general,
    ...
    public boolean equals(Object o) {
        if (o instanceof Subcase) {
            Subcase other = (Subcase) o;
