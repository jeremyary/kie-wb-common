...
@CanContain(roles = {"strip_child"})
@FormDefinition(
        startElement = "general",
        policy = FieldPolicy.ONLY_MARKED,
        defaultFieldSettings = {@FieldParam(name = FIELD_CONTAINER_PARAM, value = COLLAPSIBLE_CONTAINER)}
)
public class StripLane implements CaseManagementViewDefinition {
    ...
    public StripLane() {
        this(new CaseManagementGeneralSet("StripLane"),
             new BackgroundSet(),
             new FontSet(),
             new RectangleDimensionsSet());
    }

    public StripLane(final @MapsTo("general") CaseManagementGeneralSet general,
    ...
    public boolean equals(Object o) {
        if (o instanceof StripLane) {
            StripLane other = (StripLane) o;
