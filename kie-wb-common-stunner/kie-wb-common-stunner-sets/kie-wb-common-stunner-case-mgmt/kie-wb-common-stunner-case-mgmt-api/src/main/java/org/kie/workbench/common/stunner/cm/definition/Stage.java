...
@CanContain(roles = {"strip_lane"})
@FormDefinition(
        startElement = "general",
        policy = FieldPolicy.ONLY_MARKED,
        defaultFieldSettings = {@FieldParam(name = FIELD_CONTAINER_PARAM, value = COLLAPSIBLE_CONTAINER)}
)
public class Stage implements CaseManagementViewDefinition {

    @Category
    public static final transient String category = CaseManagementCategories.STAGE;
    ...
    public Stage() {
        this(new CaseManagementGeneralSet("Stage"),
             new BackgroundSet(),
             new FontSet(),
             new RectangleDimensionsSet());
    }

    public Stage(final @MapsTo("general") CaseManagementGeneralSet general,
