...
public class HumanTaskShapeDef extends BaseDimensionedShapeDef implements CaseManagementSvgShapeDef<HumanTask> {

    @Override
    public FontHandler<HumanTask, SVGShapeView> newFontHandler() {
    ...
    @Override
    public SizeHandler<HumanTask, SVGShapeView> newSizeHandler() {
    ...
    @Override
    public SVGShapeView<?> newViewInstance(final CaseManagementSvgViewFactory factory, final HumanTask task) {
    ...
    @Override
    public Glyph getGlyph(final Class<? extends HumanTask> type, final String defId) {
        return CaseManagementSvgGlyphFactory.USER_TASK_GLYPH;
    }
}
