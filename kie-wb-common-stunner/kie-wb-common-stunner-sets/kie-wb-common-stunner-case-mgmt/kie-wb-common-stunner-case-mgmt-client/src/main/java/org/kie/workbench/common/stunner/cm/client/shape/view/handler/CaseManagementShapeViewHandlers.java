...
public class CaseManagementShapeViewHandlers {

    public static final TitleHandler<ShapeView> TITLE_HANDLER = new TitleHandler<>();

    public static class FontHandlerBuilder<W extends CaseManagementViewDefinition, V extends ShapeView>
    ...
    public static class ViewAttributesHandlerBuilder<W extends CaseManagementViewDefinition, V extends ShapeView>
