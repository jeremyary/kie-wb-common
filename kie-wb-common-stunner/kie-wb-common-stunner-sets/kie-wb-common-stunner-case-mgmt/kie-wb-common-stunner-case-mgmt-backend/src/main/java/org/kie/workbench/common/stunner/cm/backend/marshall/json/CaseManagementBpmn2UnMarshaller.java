...
import org.kie.workbench.common.stunner.cm.backend.marshall.json.builder.CaseManagementGraphGenerator;
...
public class CaseManagementBpmn2UnMarshaller extends Bpmn2JsonMarshaller {
    ...
    CaseManagementGraphGenerator caseManagementGraphGenerator;

    public CaseManagementBpmn2UnMarshaller(final GraphObjectBuilderFactory elementBuilderFactory,
                                           ...
                                           final Class<? extends CaseManagementDiagram> diagramDefinitionClass) {
        this.caseManagementGraphGenerator = new CaseManagementGraphGenerator(elementBuilderFactory,
                                                                             definitionManager,
                                                                             factoryManager,
    ...
    public Graph unmarshall(final String content) throws IOException {
        ...
        final XMLResource outResource = (XMLResource) resourceSet.createResource(
                URI.createURI("inputStream://" + UUID.uuid() + ".xml"));
        ...
        outResource.load(new BufferedInputStream(
                new ByteArrayInputStream(content.getBytes("UTF-8"))), options);
    ...
    public Graph unmarshall(final Definitions def, final String preProcessingData) throws IOException {

        DroolsPackageImpl.init();
        BpsimPackageImpl.init();

        super.marshall(caseManagementGraphGenerator, def, preProcessingData);
        caseManagementGraphGenerator.close();
        return caseManagementGraphGenerator.createGraph();
    }
}
