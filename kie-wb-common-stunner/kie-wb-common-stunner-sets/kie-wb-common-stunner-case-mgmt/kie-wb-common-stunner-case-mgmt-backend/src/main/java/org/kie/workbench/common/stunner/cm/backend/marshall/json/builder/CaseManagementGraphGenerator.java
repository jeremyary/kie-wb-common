...
public class CaseManagementGraphGenerator extends JsonGenerator {
    ...
    private final Class<? extends CaseManagmentDefinition> diagramDefinitionClass;
    ...
    public CaseManagementGraphGenerator(final GraphObjectBuilderFactory bpmnGraphBuilderFactory,
    ...
    public Graph<DefinitionSet, Node> createGraph() {
        ...
        if (null == graph.getContent().getBounds()) {
            graph.getContent().setBounds(new BoundsImpl(
                    new BoundImpl(0d, 0d),
                    new BoundImpl(CaseManagementGraphFactory.GRAPH_DEFAULT_WIDTH, CaseManagementGraphFactory.GRAPH_DEFAULT_HEIGHT)
            ));
        }
        builderContext
        ...
        Node<View<CaseManagmentDefinition>, Edge> diagramNode =
                (Node<View<CaseManagmentDefinition>, Edge>) diagramBuilder.build(builderContext);
